...
const ChatList = ({ userType, userId }) => {
    ...
    useEffect(() => {
        const fetchChats = async () => {
            try {
                setLoading(true);
                const endpoint =
                    userType === "student" ? `/api/chats/student/${userId}` : `/api/chats/landlord/${userId}`;
    ...
    if (loading)
        return <div className="flex items-center justify-center h-full p-4 text-gray-500">Loading chats...</div>;
                ...
                <div className="flex flex-col items-center justify-center h-full text-center p-4">
                    ...
                    {userType === "student" && (
                        <p className="text-sm text-gray-400">
                            Browse properties and contact landlords to start a conversation
                        </p>
                    )}
                </div>
            ) : (
                        ...
                        >
                            ...
                            <div className="flex-1 min-w-0">
                                <div className="flex justify-between items-center mb-1">
                                    <h3 className="font-medium text-sm truncate m-0">
